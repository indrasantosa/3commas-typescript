...
export interface APIOptions {
    ...
    errorHandler?: (response: ThreeCommasError, reject: (reason?: any) => void) => void | Promise<any>;
}
...
export declare type Channel = 'SmartTradesChannel' | 'DealsChannel';
export declare type WebsocketCallback = (data: WebSocket.Data) => void;
